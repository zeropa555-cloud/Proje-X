...
If you are using (URP or HDRP) and see pink materials, you need to convert them. Select all pink materials and go to menu (Edit > Rendering > Materials > Convert All Built-in Materials to (URP or HDRP))
